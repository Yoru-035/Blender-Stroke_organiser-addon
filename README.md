# Blender-Stroke_organiser-addon

Stroke_organiser est ou outil addon pour Blender 5.0.1, une version stable, et juste avant le grand changement du fonctionnement des objets Grease Pencil. 
...
-de trouver une zone de casse durant l’interpolation et de rapidement ajouter une frame interpolée pour corriger avec le stepper,
-de selectioner automatiquement les calques et traits étant liés,
...
notes :
-cet outil a nécessité l’intervention d’ l’IA generatives pour des bugs complexes et l’organisation globale du fichier
